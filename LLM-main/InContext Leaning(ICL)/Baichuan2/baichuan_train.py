...
with open(f"/home/pod/shared-nvme/llm_baichuan2/ICL/bragging_results/sample/baichuan_bragging_icl_{num_class}_{random_seed}.txt", "w", encoding="utf-8") as f:
...
with open(f"/home/pod/shared-nvme/llm_baichuan2/ICL/bragging_results/results/baichuan_bragging_icl_{num_class}_{random_seed}.json", "w", encoding='utf-8') as f:
