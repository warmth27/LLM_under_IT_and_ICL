...
def predict(prompt, model, tokenizer, new_input):
    ...
    generated_ids = model.generate(input_ids=model_inputs.input_ids, max_new_tokens=50, temperature = temperature)
...
model_path = "/opt/data/private/Qwen2-7B-Instruct/"
train_dataset_path = "/opt/data/private/datasets/bragging/train_pro.jsonl"
test_dataset_path = "/opt/data/private/datasets/bragging/test_pro_nolabel.jsonl"
train_jsonl_new_path = "/opt/data/private/datasets/bragging/icl_qi_train_pro.jsonl"
test_jsonl_new_path = "/opt/data/private/datasets/bragging/icl_qi_test_pro_nolabel.jsonl"
...
with open(f"/opt/data/private/samples/qwen2_7b_bragging_icl_{num_class}_{random_seed}.txt", "w", encoding="utf-8") as f:
...
with open(f"/opt/data/private/samples/qwen2_7b_ins_bragging_icl_{num_class}_{random_seed}.json", "w", encoding='utf-8') as f:
