...
train_dataset_path = "bragging/train_pro.jsonl"
test_dataset_path = "bragging/test_pro_nolabel.jsonl"
train_jsonl_new_path = "bragging/new_train_pro.jsonl"
test_jsonl_new_path = "bragging/new_test_pro_nolabel.jsonl"
...
with open(f"/home/qust521/Public/InstructionTuning/Phi-3/samples/phi-3_bragging_icl_{num_class}_{random_seed}.txt", "w", encoding="utf-8") as f:
...
args = TrainingArguments(
    output_dir=f"/home/qust521/Public/InstructionTuning/Phi-3/output/phi-3-{num_class}-{random_seed}",
...
with open(f"/home/qust521/Public/InstructionTuning/Phi-3/phi-3_bragging_icl_{num_class}_{random_seed}.json", "w", encoding='utf-8') as f:
